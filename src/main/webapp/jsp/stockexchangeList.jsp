...
%>
      ...
      <div class="col-sm-4"><a href="updatestock?id=<%=stock.getStockId() %>"  class="btn btn-primary">Update</a></div>
       <div class="col-sm-4"><a href="deletestock?id=<%=stock.getStockId() %>"  class="btn btn-primary">Delete</a>
      </div>
      </div></td>   
      </tr>
      <% }%>       
